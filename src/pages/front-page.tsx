    ...
    <div className=" bg-[#f9f6f2] w-full h-full   ">
      ...
      <div className="absolute  z-20 p-[10%] top-0 bottom-0 left-0 right-0 ">
        <div className="w-full h-full flex flex-col justify-center items-center bg-white">
          <p className="text-[#6B8BA8] text-xs tracking-[0.1em] uppercase mb-8 font-extralight">
            Our Sincere
          </p>

          <div className="text-[#3B4F6B] mb-12 cookie-regular text-center">
            <p className="text-7xl mb-2 leading-none">Thank</p>
            <p className="text-7xl leading-none">You</p>
          </div>

          <p className="text-[#6B8BA8] text-xs tracking-[0.12em] uppercase text-center font-extralight leading-relaxed">
